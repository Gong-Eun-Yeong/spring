...
<body>
	...
	<form action="list" name="frm">
		...
		<select name="perPageNum">
			...
			<option value=20 <c:out value="${pm.cri.perPageNum==20?'selected':''}"/>>20행씩출력</option>
			<option value=30 <c:out value="${pm.cri.perPageNum==30?'selected':''}"/>>30행씩출력</option>
		</select>
		검색수:<fmt:formatNumber value="${pm.totalCount}" pattern="#,###"/>
	</form>
	</div>
	<table border=1>
